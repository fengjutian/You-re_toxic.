...
const tipsMap = {
  control: [
    '意识到哪些行为属于干预你的决策，记录模式。（认知）',
    '在重要决定前列出自己的优先事项，明确边界后再讨论。（行动）',
    '当对方干预时使用“I感受…”句式表达需求，减少冲突。（行动）',
    '必要时延迟决策，确保选择来源于自身意愿。（行动）',
    '每天写下三件自己做出的独立决定，增强自主感。（正向强化）',
    '对干预行为保持观察者心态，分清事实与情绪反应。（认知）',
    '当产生不满时，先深呼吸再回应，避免情绪化。（情绪）',
    '建立自我确认机制，确保重要决策由自身主导。（正向强化）',
    '与信任的人讨论决策过程，获得第三方视角。（行动）',
    '定期回顾被干预的模式，识别趋势并制定应对策略。（认知）'
  ],
  devalue: [
    '承认自己的感受，避免轻易否定自己的情绪。（认知）',
    '将感受写下来，与信任的人分享以获得支持。（情绪）',
    '在沟通中使用“I感受…”句式表达自己，减少被弱化可能。（行动）',
    '每天写下三件自己做得好的事情，强化自我价值。（正向强化）',
    '记录贬低言语或行为模式，在安全环境中讨论。（认知）',
    '感受到被轻视时，先冷静回应而非顺从或冲突。（情绪）',
    '练习积极自我肯定，如每天对自己说“我值得尊重”。（正向强化）',
    '与信任的人讨论边界问题，获得支持和反馈。（行动）',
    '识别潜在操控行为，学会保持心理防护。（认知）',
    '设置个人情绪恢复时间，缓解被贬低带来的压力。（情绪）'
  ],
  selfish: [
    '评估关系中的付出与回报是否平衡，明确界限。（认知）',
    '学会说“不”，拒绝过度牺牲自己满足他人需求。（行动）',
    '设定小目标保护自身利益，避免被消耗。（行动）',
    '优先安排自我时间，维护心理和身体能量。（情绪）',
    '观察互动模式，识别自我为中心行为信号。（认知）',
    '在冲突中坚持公平原则，避免盲目妥协。（行动）',
    '记录自己积极行动的效果，增强正向反馈。（正向强化）',
    '当对方过度自我中心时，先暂停再回应，确保情绪稳定。（情绪）',
    '设定明确期望，防止对方过度索取。（行动）',
    '定期回顾付出与回报差异，做出调整或沟通。（认知）'
  ],
  emotional: [
    '留意自己情绪被影响的时刻，做情绪记录。（认知）',
    '设定个人情绪恢复时间，如短暂休息、冥想或散步。（情绪）',
    '练习深呼吸或正念，让情绪不被外界牵动过度。（情绪）',
    '建立情绪缓冲机制，如写日记、听音乐或运动。（行动）',
    '识别情绪触发点，提前准备应对策略。（认知）',
    '在互动中尝试保持观察者心态，分清自身与他人情绪。（认知）',
    '当情绪被影响时，先记录感受再回应，避免冲动。（行动）',
    '练习正向自我对话，如“我可以处理这些情绪”。（正向强化）',
    '通过运动或休息释放积累的情绪压力。（情绪）',
    '定期回顾情绪波动，寻找模式并调整策略。（认知）'
  ],
  manipulation: [
    '识别暗示性压力，如“你不想的话就算了”可能在影响决定。（认知）',
    '在决策前停顿，问自己是否真正想做。（行动）',
    '与信任的人讨论情况，获得第三方视角。（行动）',
    '练习反问技巧，如“你希望我怎么做？”，避免被引导。（行动）',
    '关注行为模式而非单次事件，形成清晰判断。（认知）',
    '记录决策过程，确保自主选择。（行动）',
    '当感到受操控时，先深呼吸再回应，保持心理稳定。（情绪）',
    '练习坚定语言和肢体语言，保护决策权。（正向强化）',
    '识别操控的触发情境，提前准备应对策略。（认知）',
    '在必要时寻求专业建议或信任朋友帮助分析情况。（行动）'
  ],
  distrust: [
    '注意质疑的频率与情境，记录事实。（认知）',
    '必要时要求明确沟通，避免模糊指责。（行动）',
    '维护边界，确保信息和行为透明可控。（行动）',
    '建立信任评估机制，区分合理质疑与不必要怀疑。（认知）',
    '寻求第三方或专业意见，核实指控是否合理。（行动）',
    '保持冷静回应，避免情绪化反应。（情绪）',
    '练习正向沟通，清晰表达自己的观点和边界。（正向强化）',
    '识别反复质疑模式，制定心理防护策略。（认知）',
    '设定心理安全区，与信任人确认感受与判断。（情绪）',
    '记录成功处理质疑的案例，增强自我信心。（正向强化）'
  ],
  emotional_drain: [
    '安排每日情绪修复时间，如运动、读书或听音乐。（行动）',
    '定期做心理减压练习，保持心理能量。（行动）',
    '避免长时间沉浸于消耗性关系，必要时短暂断开。（行动）',
    '设定每日或每周情绪检查点，监控能量水平。（认知）',
    '建立社交支持网络，在压力时寻求帮助。（行动）',
    '区分消耗性关系和建设性关系，调整投入比例。（认知）',
    '练习正向自我确认，认可自己付出的合理性。（正向强化）',
    '当能量被消耗时，优先处理自身需要再回应他人。（行动）',
    '记录消耗模式，形成行为认知图谱。（认知）',
    '使用情绪管理工具，如冥想或呼吸练习，缓解心理疲劳。（情绪）'
  ],
  self_doubt: [
    '记录关键事实和证据，帮助确认判断。（认知）',
    '对不安感进行反思，而非盲目自责。（情绪）',
    '向信任的人或专业人士寻求反馈和建议。（行动）',
    '练习自我肯定，记录个人成就和正向反馈。（正向强化）',
    '建立理性决策流程，减少情绪干扰。（行动）',
    '识别触发自我怀疑事件，提前准备应对策略。（认知）',
    '练习情境重构，将消极想法转化为学习机会。（认知）',
    '在怀疑时暂停做出重大决策，保护心理安全。（行动）',
    '记录成功决策案例，增强自信。（正向强化）',
    '与信任的人讨论不确定情境，获取支持和确认。（行动）'
  ],
  boundary_erosion: [
    '明确列出底线和界限，并在互动中坚持。（认知）',
    '被挑战时及时提醒自己：“这是我的界限。”（行动）',
    '学会礼貌而坚定地拒绝侵犯界限的请求。（行动）',
    '定期评估个人界限是否被尊重，必要时调整策略。（认知）',
    '使用坚定语言和肢体语言维护边界。（正向强化）',
    '在压力环境中，先暂停再回应，确保界限不被突破。（行动）',
    '与信任的人讨论界限问题，获得支持和建议。（行动）',
    '记录成功坚持界限的案例，增强自我效能感。（正向强化）',
    '识别侵界情境，提前制定应对策略。（认知）',
    '练习自我肯定，确认维护界限是合理和必要的。（情绪）'
  ],
  guilt_pressure: [
    '分辨责任和过度内疚，避免被操控。（认知）',
    '承受压力时先自问：“我是否真正愿意承担？”（行动）',
    '建立自我确认机制，肯定自己的合理选择。（正向强化）',
    '识别操控性内疚言语，保持心理防护意识。（认知）',
    '练习情境重构，将压力和责任分离。（认知）',
    '必要时向信任的人说明情况，寻求支持。（行动）',
    '练习说“不”并保持情绪稳定，拒绝非合理要求。（行动）',
    '记录成功应对内疚压力的案例，增强自信。（正向强化）',
    '识别内疚触发点，提前准备心理应对策略。（认知）',
    '定期反思责任边界，确保不被过度操控。（认知）'
  ],
  avoidance: [
    '逐步练习安全表达自己的真实感受。（行动）',
    '用书面形式或信任朋友作为练习场景。（行动）',
    '小步尝试在低风险环境中表达不满或不同意见。（行动）',
    '识别回避模式触发点，建立应对策略。（认知）',
    '在互动中先确认自身感受再表达。（行动）',
    '设定明确表达目标，逐步增加难度和频率。（行动）',
    '记录成功表达案例，增强自我信心。（正向强化）',
    '练习正向自我肯定，认可自己表达的合理性。（正向强化）',
    '在情绪紧张时使用深呼吸或冥想缓解压力。（情绪）',
    '与信任人分享表达体验，获得反馈和心理支持。（行动）'
  ],
  imbalance: [
    '审视付出与回报结构，确认关系是否公平。（认知）',
    '为自己制定合理的时间和精力分配计划。（行动）',
    '学会在不公平付出时表达感受并设定界限。（行动）',
    '记录付出与回报差异，进行客观分析。（认知）',
    '练习公平沟通技巧，确保双方理解和尊重。（行动）',
    '优先处理对自身心理和健康影响大的不平衡情况。（行动）',
    '记录成功处理不平衡情境的案例，增强自我效能感。（正向强化）',
    '识别反复不平衡模式，制定长期应对策略。（认知）',
    '与信任的人讨论付出与回报，获得第三方视角。（行动）',
    '练习正向自我肯定，认可自己合理付出的价值。（正向强化）'
  ]
}
